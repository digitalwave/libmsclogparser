...
```JSON
    {
        "entry_is_modsecline": 1,
        "entry_is_broken": 0,
        "log_entry_raw_length": 711,
        "log_date_iso": "2026-01-12 22:14:41",
        "log_date_timestamp": 1768252481.384971,
        "log_client": "1.2.3.4",
        "log_entry_class": 1,
        "log_modsec_msg": "Warning. Matched phrase \"/.env\" at REQUEST_FILENAME.",
        "log_modsec_msg_length": 52,
        "log_modsec_reason": "Matched phrase",
        "log_modsec_operator": "",
        "log_modsec_operand": "/.env",
        "log_modsec_target_name": "REQUEST_FILENAME",
        "log_modsec_target_value": "",
        "log_modsec_process_error": "",
        "log_rule_file": "/usr/share/modsecurity-crs/rules/REQUEST-930-APPLICATION-ATTACK-LFI.conf",
        "log_rule_line": "125",
        "log_rule_id": "930130",
        "log_rule_rev": "",
        "log_rule_msg": "Restricted File Access Attempt",
        "log_rule_data": "Matched Data: /.env found within REQUEST_FILENAME: /.env",
        "log_rule_severity": "CRITICAL",
        "log_rule_version": "OWASP_CRS/3.3.8",
        "log_rule_maturity": "",
        "log_rule_accuracy": "",
        "log_rule_tags_cnt": 8,
        "log_rule_tags": [
        ...
        "log_hostname": "modsecurity.digitalwave.hu",
        "log_uri": "/.env",
        "log_unique_id": "aWVkQc5DKnYkg6rxU5qO6gAAAFI",
        "log_entry_errors_cnt": 0,
        "log_entry_errors": [],
        "log_entry_errors_pos": []
    }
```
or an Nginx output:
```JSON
    {
        "entry_is_modsecline": 1,
        "entry_is_broken": 0,
        "log_entry_raw_length": 851,
        "log_date_iso": "2026-01-19 08:04:23",
        "log_date_timestamp": 1768806263.0,
        "log_client": "4.3.2.1",
        "log_entry_class": 1,
        "log_modsec_msg": "Warning. Matched \"Operator `Rx' with parameter `(?:^([\\d.]+|\\[[\\da-f:]+\\]|[\\da-f:]+)(:[\\d]+)?$)' against variable `REQUEST_HEADERS:Host' (Value: `1.2.3.4' )",
        "log_modsec_msg_length": 162,
        "log_modsec_reason": "",
        "log_modsec_operator": "Rx",
        "log_modsec_operand": "(?:^([\\d.]+|\\[[\\da-f:]+\\]|[\\da-f:]+)(:[\\d]+)?$)",
        "log_modsec_target_name": "REQUEST_HEADERS:Host",
        "log_modsec_target_value": "1.2.3.4",
        "log_modsec_process_error": "",
        "log_rule_file": "/etc/crs/4/rules/REQUEST-920-PROTOCOL-ENFORCEMENT.conf",
        "log_rule_line": "712",
        "log_rule_id": "920350",
        "log_rule_rev": "",
        "log_rule_msg": "Host header is a numeric IP address",
        "log_rule_data": "1.2.3.4",
        "log_rule_severity": "4",
        "log_rule_version": "OWASP_CRS/4.22.0",
        "log_rule_maturity": "0",
        "log_rule_accuracy": "0",
        "log_rule_tags_cnt": 8,
        "log_rule_tags": [
        ...
        "log_hostname": "1.2.3.4",
        "log_uri": "/",
        "log_unique_id": "176880626392.586715",
        "log_entry_errors_cnt": 0,
        "log_entry_errors": [],
        "log_entry_errors_pos": []
    }
